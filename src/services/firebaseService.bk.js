...
// // const deepPopulate = async (doc, fields) => {
// //   const clone = { ...doc };
// //   fields.sort();
// //   for (const path of fields) {
// //     const ref = getByPath(clone, path);
// //     if (ref?.path) {
...
// // const getSubcollection = async (parentId, subcollection) => {
// //   const parentRef = doc(db, subcollection.parentCollection, parentId);
// //   const subRef = collection(parentRef, subcollection.name);
...
// //     queryOrder.push(firestoreOrderBy(field, direction));
// //     return api;
// //   };
...
// //       populateFields = [...populateFields, ...fields];
// //     }
// //     return api;
// //   };

// //   api.hasMany = (subcollectionName) => {
// //     subcollections.push({ name: subcollectionName, parentCollection: collectionName });
// //     return api;
// //   };

// //   const applyQuery = () => {
// //     let q = ref;
// //     if (whereFilters.length || queryOrder.length || queryLimit !== null) {
// //       q = query(
// //         ref,
// //         ...whereFilters,
// //         ...queryOrder,
// //         ...(queryLimit !== null ? [firestoreLimit(queryLimit)] : [])
// //       );
// //     }
// //     return q;
// //   };
...
// //       results = await Promise.all(results.map((doc) => deepPopulate(doc, populateFields)));
// //       populateFields = [];
// //     }
...
// //             doc[sub.name] = await getSubcollection(doc.id, sub);
// //           })
// //         );
// //       }
// //       subcollections = [];
...
// //     return await processResults(snapshot);
// //   };

// //   api.onSnapshot = (callback) => {
// //     const q = applyQuery();

// //     return firestoreOnSnapshot(q, async (snapshot) => {
// //       const processed = await processResults(snapshot);
// //       callback(processed);
// //     });
// //   };
